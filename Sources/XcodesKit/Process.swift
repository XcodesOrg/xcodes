...
extension Process {
    @discardableResult
    static func sudo(password: String? = nil, _ executable: any Pathish, workingDirectory: URL? = nil, _ arguments: String...) -> Promise<ProcessOutput> {
    ...
    @discardableResult
    static func run(_ executable: any Pathish, workingDirectory: URL? = nil, input: String? = nil, _ arguments: String...) -> Promise<ProcessOutput> {
